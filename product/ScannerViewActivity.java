...
public class ScannerViewActivity extends BaseActivity implements ZXingScannerView.ResultHandler {
    ...
    private void requestCameraPermission() {
        Dexter.withActivity(this).withPermission("android.permission.CAMERA").withListener(new PermissionListener() { // from class: com.app.smartpos.product.ScannerViewActivity.1
            ...
            public void onPermissionDenied(PermissionDeniedResponse response) {
                if (response.isPermanentlyDenied()) {
                    Toasty.info(ScannerViewActivity.this, (int) R.string.camera_permission, 0).show();
                }
            }
